/*
Реализуйте и экспортируйте по умолчанию функцию, которая ведет себя аналогично
встроенной bind(obj, fn). Аргументы функции:
- obj – объект выступающий в роли контекста
- fn() – функция привязываемая к контексту

Примечания:
- Ограничение: для реализации нельзя пользоваться только встроенной функцией
  bind()
